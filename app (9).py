...
with st.container():
    ...
    # Corrected indentation for the button and the subsequent weather logic
    if st.button("🔍 Check Weather Now"):
        ...
        if response.status_code == 200:
            ...
            # ✅ ✅ Browser-based speech button inside the same block
            if st.button("🔊 Speak Forecast"):
                tts_text = f"In {city}, it is {temp} degrees Celsius with {weather}. {'Rain expected' if 'rain' in weather.lower() else 'No rain'}."
    ...
    # Close the main container div (optional, depending on desired layout)
